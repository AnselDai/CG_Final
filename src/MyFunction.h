...
void process_input(GLFWwindow* window) {
	...
	if (is_press(window, GLFW_KEY_D)) {
		lightPos.x += 1.0f;
		cout << lightPos.x << ", " << lightPos.y << ", " << lightPos.z << endl;
	}
	if (is_press(window, GLFW_KEY_Z)) {
		lightPos.y += 1.0f;
		cout << lightPos.x << ", " << lightPos.y << ", " << lightPos.z << endl;
	}
	if (is_press(window, GLFW_KEY_S)) {
		lightPos.z += 1.0f;
		cout << lightPos.x << ", " << lightPos.y << ", " << lightPos.z << endl;
	}
	if (is_press(window, GLFW_KEY_A)) {
		lightPos.x -= 1.0f;
		cout << lightPos.x << ", " << lightPos.y << ", " << lightPos.z << endl;
	}
	if (is_press(window, GLFW_KEY_X)) {
		lightPos.y -= 1.0f;
		cout << lightPos.x << ", " << lightPos.y << ", " << lightPos.z << endl;
	}
	if (is_press(window, GLFW_KEY_W)) {
		lightPos.z -= 1.0f;
		cout << lightPos.x << ", " << lightPos.y << ", " << lightPos.z << endl;
	}
	if (is_press(window, GLFW_KEY_P)) {
		if (ambient + 0.05f <= 1.0f) {
			ambient += 0.05f;
			cout << "Ambient: " << ambient << endl;
		}
	}
	if (is_press(window, GLFW_KEY_O)) {
		if (ambient - 0.05f >= 0.0f) {
			ambient -= 0.05f;
			cout << "Ambient: " << ambient << endl;
